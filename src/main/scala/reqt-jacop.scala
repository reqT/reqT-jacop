...
object jacop:  
  ...
  object JacopSolver:
    ...
    extension (vs: ValueSelection) def toJacop: jsearch.Indomain[JIntVar] = 
      ...
      /* jacop value selection methods not yet implemented:    
    ...
    extension (vs: VariableSelection) 
      def toJacopVarSel(s: jcore.Store, jvs: Array[JIntVar], valSelect: ValueSelection): jsearch.SelectChoicePoint[JIntVar] = 
        ...
        /* jacop variable selection methods not yet implemented:
          MaxCardDiff    
          MaxGlbCard    
          MaxLubCard    
          MinCardDiff    
    ...
    def solve: Result = if constraints.size > 0 then
      ...
      searchType match
        ...
        case _ => 
          ...
          def mkSolutions(listener: jsearch.SimpleSolutionListener[JIntVar]): JacopSolutions = 
            JacopSolutions(
